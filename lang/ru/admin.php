...
return [
    ...
    'recommendation_weights' => [
        'navigation' => 'Веса рекомендаций',
        'title' => 'Веса рекомендаций',
        'description' => 'Настройте, как варианты учитывают популярность, свежесть и предпочтения. Перед расчётом значения нормализуются.',
        'sections' => [
            'variant_a' => 'Веса варианта A',
            'variant_b' => 'Веса варианта B',
            'ab_split' => 'Распределение трафика и seed эксперимента',
        ],
        'fields' => [
            'pop' => 'Вес популярности',
            'recent' => 'Вес свежести',
            'pref' => 'Вес предпочтений',
            'ab_split_a' => 'Трафик варианта A',
            'ab_split_b' => 'Трафик варианта B',
            'seed' => 'Seed эксперимента',
            'seed_helper' => 'Необязательно. При заполнении назначение вариантов становится детерминированным.',
            'seed_placeholder' => 'Оставьте пустым для случайного распределения',
        ],
        'summary' => [
            'heading' => 'Нормализованные веса',
            'description' => 'Показывает долю влияния факторов после нормализации.',
            'variant' => 'Вариант :variant',
        ],
        'actions' => [
            'save' => 'Сохранить веса',
            'saved' => 'Веса рекомендаций обновлены.',
        ],
    ],
];
