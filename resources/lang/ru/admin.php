    ...
    'ssr' => [
        ...
        'headline' => [
            ...
            'source' => [
                ...
                'fallback' => 'Данные JSON-фолбэка',
                'none' => 'Нет данных',
            ],
            'paths' => '{0}Нет отслеживаемых путей|{1}:count путь • :samples измерений|[2,4]:count пути • :samples измерения|[5,*]:count путей • :samples измерений',
            ...
            'metrics' => [
                ...
                'samples' => '{0}Нет выборок|{1}:count выборка|[2,4]:count выборки|[5,*]:count выборок',
                'first_byte' => 'Время первого байта: :value мс',
                'first_byte_delta' => '(:delta мс :comparison)',
